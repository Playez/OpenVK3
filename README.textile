...
Still under development, station dev status is Beta.
...
However, OVK3 makes use of Chandler Application Server. This software requires extensions, that may not be provided by your hosting provider (namely, sodium and yaml. this extensions are available on most of ISPManager hostings).
Simply put, we would recommend you to use latest CentOS (running on your own VDS/Dedicated) with latest PHP from EPEL. We used to have this configuration on thus will be able to provide quicker support for OVK running in this environment.
...
# Run @composer install@ in OpenVK 3 directory
...
h3. If my website uses OpenVK 3, should I publish it's sources?

You are encouraged to do so. We don't enforce this though. You can keep your sources to yourself (unless you distribute your OpenVK 3 distro to other people).
You also not required to publish source texts of your themepacks and plugins.

h2. Where can I get assistance?

You may reach out to us via:
* "Bug-tracker":https://t.me/openvkch
